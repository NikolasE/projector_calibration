...
void GL_Mesh_Viewer::setLightPos(float z){light_z_pos = z;}

void GL_Mesh_Viewer::initMapSize(int img_width, int img_height, float min_x, float min_y, float width, float height){
